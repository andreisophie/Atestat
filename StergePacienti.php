<html>
    <head>
        ...
        <style>
            body {
                background-image: url('Assets/Fundal2.jpg');
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <?php
                        ...
                        $sql = "DELETE FROM pacienti WHERE ID=".$_GET["ID"].";";
                        $r = mysqli_query($connection, $sql); 

                        if ($r)
                            echo "<div class='alert alert-success' style='text-align: center;'>
                                    <span class='glyphicon glyphicon-ok'></span> Pacientul a fost șters cu succes.
                                </div>";
                        else
