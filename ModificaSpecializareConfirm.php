            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <?php
                        ...
                        $sqlv="SELECT Denumire FROM specializari WHERE Denumire='".$Denumire."';";
                        ...
                        {
                            $sql = "UPDATE `specializari` SET `Denumire`='".$Denumire."', `Salariu_baza`='".$Salariu_baza."' WHERE ID=".$ID.";";
                            $r = mysqli_query($connection, $sql); 

                            if ($r)
                            {
                                echo "<div class='alert alert-success' style='text-align: center;'>
                                        <span class='glyphicon glyphicon-ok'></span> Specializarea a modificată cu succes.
                                    </div>";
                                $_SESSION = array();
                            }
                            else
