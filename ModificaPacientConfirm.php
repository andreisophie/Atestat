<html>
    ...
    <?php
        ...
        {
            header("Location: ModificaPacient.php?ID=".$ID);
            exit;
        }
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <?php
                        ...
                        $sql = "UPDATE `pacienti` SET `Nume`='".$Nume."',  `Prenume`='".$Prenume."', `Sex`='".$Sex."', 
                                `Data nasterii`='".$Data_nasterii."', `CNP`='".$CNP."', `Telefon`='".$Telefon."', 
                                `E-mail`='".$E_mail."', `Varsta`='".$Varsta."', `ID_judet`='".$ID_judet."', `Oras`='".$Oras."', 
                                `Strada`='".$Strada."', `Cod postal`='".$Cod_postal."', `Numar`='".$Numar."', `Bloc`='".$Bloc."', 
                                `Apartament`='".$Apartament."' WHERE ID=".$ID.";";
                        $r = mysqli_query($connection, $sql); 

                        if ($r)
                        {
                            echo "<div class='alert alert-success' style='text-align: center;'>
                                    <span class='glyphicon glyphicon-ok'></span> Pacientul a fost modificat cu succes.
                                </div>";
                        }
                        else
