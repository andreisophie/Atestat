<html>
    ...
    <?php
        ...
        {
            header("Location: AdaugaSpecializare.php");
            exit;
        }
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <?php
                        ...
                        {
                            $sql = "INSERT INTO `specializari` (`Denumire`, `Salariu_baza`)
                                VALUES ('".$Denumire."', '".$Salariu_baza."');";
                            $r = mysqli_query($connection, $sql); 

                            if ($r)
                            {
                                echo "<div class='alert alert-success' style='text-align: center;'>
                                        <span class='glyphicon glyphicon-ok'></span> Specializarea a fost adăugată cu succes.
                                    </div>";
                                $_SESSION = array();
                            }
                            else
