<html>
    ...
    <?php
        ...
        {
            header("Location: AdaugaDoctor.php");
            exit;
        }
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <?php
                        ...
                        $sql = "INSERT INTO `doctori` (`Nume`, `Prenume`, `Sex`, `Data nasterii`, `CNP`, `Varsta`, `E-mail`, `Telefon`, `Sporuri salariu`, 
                                `Data angajarii`, `ID_specializare`, `ID_judet`, `Oras`, `Strada`, `Cod postal`, `Numar`, `Bloc`, `Apartament`)
                                VALUES ('".$Nume."', '".$Prenume."', '".$Sex."', '".$Data_nasterii."', '".$CNP."', '".$Varsta."', '".$E_mail."', '".$Telefon."', 
                                '".$Sporuri_salariu."', '".$Data_angajarii."', '".$ID_specializare."', '".$ID_judet."', '".$Oras."', '".$Strada."', '".$Cod_postal."', '";
                                if ($Numar)
                                    $sql.=$Numar;
                                $sql.="','";
                                if ($Bloc)
                        ...
                        if ($r)
                        {
                            echo "<div class='alert alert-success' style='text-align: center;'>
                                    <span class='glyphicon glyphicon-ok'></span> Doctorul a fost adăugat cu succes.
                                </div>";
                            $_SESSION = array();
                        }
                        else
