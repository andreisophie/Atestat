<html>
    ...
    <?php
        ...
        $sql = "SELECT ID, Nume FROM judete ORDER BY ID ASC;";
    ...
    <body>
        ...
        <div class="container-fluid">
            <form action="AdaugaPacientConfirm.php" method="post">
                <div class="row">
                                        ...
                                        <?php 
                                            ...
                                            while ($row = mysqli_fetch_array($r))
                                            {
                                                ...
                                                if (isset($_SESSION["valoareID_judet"]))
                                                    if ($_SESSION["valoareID_judet"]==$row["ID"])
                                                        echo ' selected';
                                                echo ">".$ID++." - ".$row["Nume"]."</option>";
                                            }
                                        ?>
                                        </select>
                                    </td>
