<html>
    ...
    <?php
        ...
        {
            header("Location: AdaugaMedicament.php");
            exit;
        }
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <?php
                        ...
                        {
                            $sql = "INSERT INTO `medicamente` (`Denumire`) VALUES ('".$Denumire."');";
                            $r = mysqli_query($connection, $sql); 

                            if ($r)
                                echo "<div class='alert alert-success' style='text-align: center;'>
                                        <span class='glyphicon glyphicon-ok'></span> Medicamentul a fost adăugat cu succes.
                                    </div>";
                            else
